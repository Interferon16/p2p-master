...
public class Message implements Serializable {
    ...
    private CopyOnWriteArrayList<FileNode> ListOfSharedFiles;
    ...
    public CopyOnWriteArrayList<FileNode> getListOfSharedFiles() {
        return ListOfSharedFiles;
    }

    public void setListOfSharedFiles(CopyOnWriteArrayList<FileNode> listOfSharedFiles) {
